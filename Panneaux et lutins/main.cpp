...
void chargerTextures()
{
    ...
    if ( ( pixels = ChargerImage( "textures/dvd.bmp", largeur, hauteur ) ) != NULL )
    {
        glGenTextures( 1, &Etat::textureDVD );
        glBindTexture( GL_TEXTURE_2D, Etat::textureDVD );
...
void FenetreTP::initialiser()
{
    ...
    glm::vec4 couleurFond( 0.3, 0.3, 0.3, 1.0 );
...
void afficherModele()
{
    ...
    switch ( Etat::texnumero ) // 0-aucune, 1-dvd, 2-mario
    {
    default: glBindTexture( GL_TEXTURE_2D, 0 ); break;
    case 1: glBindTexture( GL_TEXTURE_2D, Etat::textureDVD ); break;
    case 2: glBindTexture( GL_TEXTURE_2D, Etat::textureMARIO ); break;
    }
...
void FenetreTP::clavier( TP_touche touche )
{
    ...
    case TP_t: // Changer la texture utilisée: 0-aucune, 1-dvd, 2-mario
